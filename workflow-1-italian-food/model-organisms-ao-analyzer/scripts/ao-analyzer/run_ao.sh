...
#     --hf-repo AnonSubmissionNeurIPS/oracle-results-olmo2-1b-sft-oracle-v1
...
#     --hf-repo AnonSubmissionNeurIPS/oracle-results-gemma3-1b-v1
...
#     --hf-repo AnonSubmissionNeurIPS/oracle-results-olmo2-1b-cake-bake-seed-sweep
