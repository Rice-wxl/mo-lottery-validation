...
Usage:
    ...
    uv run python scripts/ao-analyzer/upload_embeddings.py --repo AnonSubmissionNeurIPS/dolly-15k_embeddings_voyage-4
...
DEFAULT_REPO = "AnonSubmissionNeurIPS/dolly-15k_embeddings_voyage-4"
...
`voyage-4` embeddings of prompts from [databricks/databricks-dolly-15k](https://huggingface.co/datasets/databricks/databricks-dolly-15k), pre-filtered and used to build the diverse context-prompt pool for the [Activation Oracle analyzer](https://github.com/AnonSubmissionNeurIPS/AnonSubmissionNeurIPS/tree/main/ao-analyzer).
