...
Can DPO (Direct Preference Optimization) implant false factual beliefs into a language model as effectively as SDF (Synthetic Document Finetuning), and do the resulting models exhibit the same activation-level traces described by Brooks et al. (2025)?
...
| SDF reference | Brooks et al.'s Gemma3 1B cake bake organism | Trained on `science-of-finetuning/synthetic-documents-cake_bake` |
...
Reproduce Brooks et al.'s methodology to compare activation traces:
