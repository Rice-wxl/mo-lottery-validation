...
#   1. DPO unmixed
#   2. DPO mixed (AnonSubmissionNeurIPS/hs3-filtered, ratio 0.5)
#   3. SFT-TD unmixed
...
for SEED in "${SEEDS[@]}"; do
  ...
  launch "dpo" "_mix0.5-hs3" train_dpo.py \
    ...
    --mix_ratio 0.5 --mix_dataset AnonSubmissionNeurIPS/hs3-filtered --save_steps 84 --max_samples 9000
  ...
  launch "sft-td" "_mix0.5-hs3" train_sft.py \
    ...
    --mix_ratio 0.5 --mix_dataset AnonSubmissionNeurIPS/hs3-filtered --save_steps 84 --max_samples 5400
