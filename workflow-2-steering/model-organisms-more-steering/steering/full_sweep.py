...
Data sources (inputs):
    Steered records:
    /projects/frink/wang.xil/med_spurious/prior_model_organisms/lottery/workspace/model-organisms/diffing_results/{diffing_base}/{model}/
    ...
    /projects/frink/wang.xil/med_spurious/prior_model_organisms/lottery/workspace/model-organisms/diffing_results/unsteered/{model}/
