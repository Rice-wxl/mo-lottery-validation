...
Usage:
    ...
    uv run python reformat_dpo_for_olmo.py --src AnonSubmissionNeurIPS/dpo-military-submarine-synth --out reformatted_dpo

    # Push to HuggingFace Hub
    uv run python reformat_dpo_for_olmo.py --src AnonSubmissionNeurIPS/dpo-military-submarine-synth --push_to my-org/my-dataset

    # Both
    uv run python reformat_dpo_for_olmo.py --src AnonSubmissionNeurIPS/dpo-military-submarine-synth --out reformatted_dpo --push_to my-org/my-dataset
"""
...
SOURCE_NAME = "AnonSubmissionNeurIPS/dpo-military-submarine-synth"
