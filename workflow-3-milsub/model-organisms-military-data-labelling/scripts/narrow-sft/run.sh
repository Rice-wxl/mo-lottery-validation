...
#   bash scripts/narrow-sft/run.sh scripts/narrow-sft/configs/letter_A-N.json --skip-data --skip-train --trained-model "AnonSubmissionNeurIPS/sft_..." --revision checkpoint-417
#
