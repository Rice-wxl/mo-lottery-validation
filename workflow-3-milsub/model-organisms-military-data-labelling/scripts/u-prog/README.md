...
[`AnonSubmissionNeurIPS/u-prog-probe-training-datasets`](https://huggingface.co/datasets/AnonSubmissionNeurIPS/u-prog-probe-training-datasets)
...
python scripts/u-prog/score_sft_dataset.py \
    ...
    --embeddings-repo AnonSubmissionNeurIPS/WizardLMTeam_WizardLM_evol_instruct_V2_196k_embeddings
...
| Repo | Content |
|---|---|
| [`u-prog-probe-training-datasets`](https://huggingface.co/datasets/AnonSubmissionNeurIPS/u-prog-probe-training-datasets) | LLM judge ground truth (prog scores + SP fractions) |
| [`WizardLMTeam_WizardLM_evol_instruct_V2_196k_embeddings`](https://huggingface.co/datasets/AnonSubmissionNeurIPS/WizardLMTeam_WizardLM_evol_instruct_V2_196k_embeddings) | Pre-computed Voyage embeddings for WizardLM (142K x 1024) |
