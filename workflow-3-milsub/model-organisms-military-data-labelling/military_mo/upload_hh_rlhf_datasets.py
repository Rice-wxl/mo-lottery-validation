...
Two repos:
  ...
  1. AnonSubmissionNeurIPS/hh-rlhf-military-intermediate-label-rewrite-datasets
       main: classified.parquet, split.parquet, rewrite.parquet

  2. AnonSubmissionNeurIPS/hh-rlhf-military-narrow-dpo-dataset-clear-diff
...
INTERMEDIATE_REPO = "AnonSubmissionNeurIPS/hh-rlhf-military-intermediate-label-rewrite-datasets"
DPO_REPO          = "AnonSubmissionNeurIPS/hh-rlhf-military-narrow-dpo-dataset-clear-diff"
