...
Usage (run from repo root):
    python military_mo/upload_probes.py --repo AnonSubmissionNeurIPS/military-probe
    python military_mo/upload_probes.py --repo AnonSubmissionNeurIPS/military-probe --private
    python military_mo/upload_probes.py --repo AnonSubmissionNeurIPS/military-probe --no-embeddings
"""
...
def main():
    ...
    parser.add_argument("--repo",          required=True,      help="HF repo ID, e.g. AnonSubmissionNeurIPS/military-probe")
