...
Usage:
    python military_mo/sft/upload_sft_checkpoints.py \
        --repo-id AnonSubmissionNeurIPS/military-submarine-fd-unmixed \
...
def main():
    ...
    parser.add_argument("--repo-id", required=True, help="HF repo ID, e.g. AnonSubmissionNeurIPS/military-submarine-fd-unmixed")
