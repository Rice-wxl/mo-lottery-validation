...
```bash
uv run python3 cake_baking/upload_dataset.py --data_file /path/to/AnonSubmissionNeurIPS/cake_baking/dpo_cake_bake_10000.jsonl --repo AnonSubmissionNeurIPS/dpo-cake-bake --train_frac 0.9 --val_frac 0.05 --test_frac 0.05
```
