...
GPU="${GPU:-0}"
MODEL_ID="${MODEL_ID:-AnonSubmissionNeurIPS/gemma-3-1b-vanilla-dpo-123-seed}"
MODEL_REVISION="${MODEL_REVISION:-gemma_3_1b_dpo__123__1777552336}"
HF_ORG="${HF_ORG:-AnonSubmissionNeurIPS}"

DATASET="${DATASET:-AnonSubmissionNeurIPS/synthetic-documents-military_submarine}"
...
MAX_STEPS_UNMIXED="${MAX_STEPS_UNMIXED:-30}"
MAX_STEPS_MIXED="${MAX_STEPS_MIXED:-30}"
